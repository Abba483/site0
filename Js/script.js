//© Salvador - Código libre no comercial
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Te amo 3 millones";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-09-04T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-09-04T00:00:00');
